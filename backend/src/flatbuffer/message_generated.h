...
struct CountingClientData;
struct CountingClientDataBuilder;

struct CountingGameState;
struct CountingGameStateBuilder;
...
enum GameStatePayload : uint8_t {
  ...
  GameStatePayload_CountingClientData = 1,
  GameStatePayload_CountingGameState = 2,
  GameStatePayload_MIN = GameStatePayload_NONE,
  GameStatePayload_MAX = GameStatePayload_CountingGameState
};

inline const GameStatePayload (&EnumValuesGameStatePayload())[3] {
  static const GameStatePayload values[] = {GameStatePayload_NONE,
                                            GameStatePayload_CountingClientData,
                                            GameStatePayload_CountingGameState};
  return values;
}

inline const char *const *EnumNamesGameStatePayload() {
  static const char *const names[4] = {"NONE", "CountingClientData",
                                       "CountingGameState", nullptr};
  return names;
}
...
template <>
struct GameStatePayloadTraits<CountingClientData> {
  static const GameStatePayload enum_value =
      GameStatePayload_CountingClientData;
};

template <>
struct GameStatePayloadTraits<CountingGameState> {
  static const GameStatePayload enum_value = GameStatePayload_CountingGameState;
};
...
struct CountingClientData FLATBUFFERS_FINAL_CLASS
    : private ::flatbuffers::Table {
  typedef CountingClientDataBuilder Builder;
...
struct CountingClientDataBuilder {
  typedef CountingClientData Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_new_int(int16_t new_int) {
    fbb_.AddElement<int16_t>(CountingClientData::VT_NEW_INT, new_int, 0);
  }
  explicit CountingClientDataBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
      : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<CountingClientData> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<CountingClientData>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<CountingClientData> CreateCountingClientData(
    ::flatbuffers::FlatBufferBuilder &_fbb, int16_t new_int = 0) {
  CountingClientDataBuilder builder_(_fbb);
  builder_.add_new_int(new_int);
  return builder_.Finish();
}

struct CountingGameState FLATBUFFERS_FINAL_CLASS
    : private ::flatbuffers::Table {
  typedef CountingGameStateBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_OBJECTS = 4
  };
...
struct CountingGameStateBuilder {
  typedef CountingGameState Table;
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_objects(::flatbuffers::Offset<
                   ::flatbuffers::Vector<::flatbuffers::Offset<Object>>>
                       objects) {
    fbb_.AddOffset(CountingGameState::VT_OBJECTS, objects);
  }
  explicit CountingGameStateBuilder(::flatbuffers::FlatBufferBuilder &_fbb)
      : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
  ::flatbuffers::Offset<CountingGameState> Finish() {
    const auto end = fbb_.EndTable(start_);
    auto o = ::flatbuffers::Offset<CountingGameState>(end);
    return o;
  }
};

inline ::flatbuffers::Offset<CountingGameState> CreateCountingGameState(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<Object>>>
        objects = 0) {
  CountingGameStateBuilder builder_(_fbb);
  builder_.add_objects(objects);
  return builder_.Finish();
}

inline ::flatbuffers::Offset<CountingGameState> CreateCountingGameStateDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<::flatbuffers::Offset<Object>> *objects = nullptr) {
  auto objects__ =
      objects ? _fbb.CreateVector<::flatbuffers::Offset<Object>>(*objects) : 0;
  return CreateCountingGameState(_fbb, objects__);
}
...
struct GameStatePayloadType FLATBUFFERS_FINAL_CLASS
  ...
  const CountingClientData *gamestatepayload_as_CountingClientData() const {
    return gamestatepayload_type() == GameStatePayload_CountingClientData
               ? static_cast<const CountingClientData *>(gamestatepayload())
               : nullptr;
  }
  const CountingGameState *gamestatepayload_as_CountingGameState() const {
    return gamestatepayload_type() == GameStatePayload_CountingGameState
               ? static_cast<const CountingGameState *>(gamestatepayload())
               : nullptr;
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template <>
inline const CountingClientData *
GameStatePayloadType::gamestatepayload_as<CountingClientData>() const {
  return gamestatepayload_as_CountingClientData();
}

template <>
inline const CountingGameState *
GameStatePayloadType::gamestatepayload_as<CountingGameState>() const {
  return gamestatepayload_as_CountingGameState();
}
...
inline bool VerifyGameStatePayload(::flatbuffers::Verifier &verifier,
  ...
  switch (type) {
    ...
    case GameStatePayload_CountingClientData: {
      auto ptr = reinterpret_cast<const CountingClientData *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case GameStatePayload_CountingGameState: {
      auto ptr = reinterpret_cast<const CountingGameState *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default:
      return true;
