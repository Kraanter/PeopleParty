    ...
    <div class="container flex flex-col items-center overflow-y-auto">
        <div id="hero" class="min-h-screen">
            ...
            <div id="ctaButtons" class="flex flex-col justify-center items-center p-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2.5"
                    stroke="currentColor" class="size-7 w-10 mt-1 animate-bounce">
        ...
        <div id="info" class="flex flex-col w-full bg-secondary text-justify font-regular py-16 mt-4 rounded-xl gap-12" :class="isMobile() ? 'px-10 text-xl' : 'px-20 text-2xl'">
            <div id="How to Play" class="flex flex-col gap-4">
                ...
                <div>
                    People Party is easy to play and requires no special skills or equipment. Simply create a party or join an existing one, and you'll be presented with a series of fun and interactive challenges. Compete against your friends to earn points and climb the leaderboard!
                </div>
                <div>
            ...
            <div id="Minigames" class="flex flex-col gap-4">
                ...
                <div class="flex flex-col items-center">
                    ...
                    >
                        ...
                        <img
                            class="carousel-img"
                            src="assets/games/memoryMixer/memoryMixerLogo.svg"
                        >
                        <img
                            class="carousel-img"
                            src="assets/games/businessBailout/businessBailoutLogo.svg"
                        >
                        <img
                            class="carousel-img"
                            src="assets/games/launchParty/launchPartyLogo.svg"
                        >
                        <img
                            class="carousel-img"
                            src="assets/games/rpsBracket/rpsBracketLogo.svg"
                        >
                    </n-carousel>
                </div>
                <div>
