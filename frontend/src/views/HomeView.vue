  ...
  methods: {
    ...
    sendMessage(newInt: number) {
      if (this.socket) {
        ...
        let ff = GameStatePayloadType.createGameStatePayloadType(
          builder,
          GameStateType.CountingClientData,
          GameStatePayload.CountingClientDataPayload,
          ff2
        )
        let messagePacket2 = Message.createMessage(
          builder,
          MessageType.GameState,
          Payload.GameStatePayloadType,
          ff
        )
