...
import { FBLeaderboardPlayer } from './fbleaderboard-player.js';


export class LeaderboardInformationPayload {
  bb: flatbuffers.ByteBuffer|null = null;
  bb_pos = 0;
  __init(i:number, bb:flatbuffers.ByteBuffer):LeaderboardInformationPayload {
  this.bb_pos = i;
  this.bb = bb;
  return this;
}

static getRootAsLeaderboardInformationPayload(bb:flatbuffers.ByteBuffer, obj?:LeaderboardInformationPayload):LeaderboardInformationPayload {
  return (obj || new LeaderboardInformationPayload()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsLeaderboardInformationPayload(bb:flatbuffers.ByteBuffer, obj?:LeaderboardInformationPayload):LeaderboardInformationPayload {
  bb.setPosition(bb.position() + flatbuffers.SIZE_PREFIX_LENGTH);
  return (obj || new LeaderboardInformationPayload()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

leaderboardTimeLeft():bigint {
...
static startLeaderboardVector(builder:flatbuffers.Builder, numElems:number) {
  builder.startVector(4, numElems, 4);
}

static endLeaderboardInformationPayload(builder:flatbuffers.Builder):flatbuffers.Offset {
