...
static getRootAsCrazyCountingPlayerTimePayload(bb:flatbuffers.ByteBuffer, obj?:CrazyCountingPlayerTimePayload):CrazyCountingPlayerTimePayload {
  return (obj || new CrazyCountingPlayerTimePayload()).__init(bb.readInt32(bb.position()) + bb.position(), bb);
}

static getSizePrefixedRootAsCrazyCountingPlayerTimePayload(bb:flatbuffers.ByteBuffer, obj?:CrazyCountingPlayerTimePayload):CrazyCountingPlayerTimePayload {
...
static createCrazyCountingPlayerTimePayload(builder:flatbuffers.Builder, timeLeft:number):flatbuffers.Offset {
