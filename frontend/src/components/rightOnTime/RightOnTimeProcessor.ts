...
import type { RightOnTimeResultPair, RightOnTimeRoundResultPair } from "./RightOnTimeModels"
import { RightOnTimeRoundResultPayload } from "@/flatbuffers/right-on-time-round-result-payload"


export function parseRightOnTimePayload(data: MiniGamePayloadType) {
...
export function parseRightOnTimeRoundResults(data: MiniGamePayloadType, clientName: string = '') {
...
export function parseRightOnTimeResults(data: MiniGamePayloadType, clientName: string = '') {
