...
import type { UnscrambledHostData, UnscrambledPlayerData, UnscrambledResultPair, UnscrambledResults, UnscrambledRoundResultPair, UnscrambledRoundResults } from "./UnscrambledModels"
...
export function parseUnscrambledRoundResults(data: MiniGamePayloadType, clientName: string = ''): UnscrambledRoundResults {
    const miniGameResultPayload: UnscrambledRoundResultPayload = data.gamestatepayload(new UnscrambledRoundResultPayload())
...
export function parseUnscrambledResults(data: MiniGamePayloadType): UnscrambledResults {
    const miniGameResultPayload: UnscrambledResultPayload = data.gamestatepayload(new UnscrambledResultPayload())
