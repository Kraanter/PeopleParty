...
<template>
  <div class="grid grid-cols-3 gap-12 grid-rows-1 h-full w-full">
    ...
    <div class="flex flex-col col-span-2 w-full justify-stretch items-stretch gap-4">
      <div class="grid grid-cols-6 w-full items-baseline px-4">
